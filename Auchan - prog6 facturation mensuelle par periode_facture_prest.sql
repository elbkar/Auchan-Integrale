-- Auchan - prog6 facturation mensuelle par periode_facture_prest
...
SELECT T0.MOIS,
SUM(CASE WHEN T1.ANNEE = 2019 THEN T1.FACTU_TTC_PRESTA ELSE NULL END) AS '2019',
SUM(CASE WHEN T1.ANNEE = 2018 THEN T1.FACTU_TTC_PRESTA ELSE NULL END) AS '2018',
SUM(CASE WHEN T1.ANNEE = 2017 THEN T1.FACTU_TTC_PRESTA ELSE NULL END) AS '2017',
SUM(CASE WHEN T1.ANNEE = 2016 THEN T1.FACTU_TTC_PRESTA ELSE NULL END) AS '2016',
SUM(CASE WHEN T1.ANNEE = 2015 THEN T1.FACTU_TTC_PRESTA ELSE NULL END) AS '2015',
SUM(CASE WHEN T1.ANNEE = 2014 THEN T1.FACTU_TTC_PRESTA ELSE NULL END) AS '2014'
FROM
(
-- calendrier
